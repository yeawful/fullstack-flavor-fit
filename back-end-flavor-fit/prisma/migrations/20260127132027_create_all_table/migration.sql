...
CREATE TABLE "order_items" (
    "id" TEXT NOT NULL,
    "recipeIngredientsid" TEXT NOT NULL,
...
CREATE TABLE "profiles" (
    ...
    "bio" TEXT,
    "user_id" TEXT NOT NULL,
    "createrd_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "order_items" ADD CONSTRAINT "order_items_recipeIngredientsid_fkey" FOREIGN KEY ("recipeIngredientsid") REFERENCES "recipe_ingredients"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
