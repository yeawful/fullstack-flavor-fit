/*
  ...
  - You are about to drop the column `recipeIngredientsid` on the `order_items` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "order_items" DROP CONSTRAINT "order_items_recipeIngredientsid_fkey";

-- AlterTable
ALTER TABLE "order_items" DROP COLUMN "recipeIngredientsid",
