...
export type GetRecipeBySlugQuery = { __typename?: 'Query', recipeBySlug: { __typename?: 'RecipeModel', image: string, title: string, description: string, slug: string, calories: number, cookingTime: number, difficulty: Difficulty, mealType: MealType, author: { __typename?: 'UserModel', avatarUrl?: string | null, profile?: { __typename?: 'ProfileModel', fullName: string } | null }, tags?: Array<{ __typename?: 'RecipeTagModel', name: string }> | null, recipeIngredients?: Array<{ __typename?: 'RecipeIngredientModel', quantity: number, unit: Unit, ingredient: { __typename?: 'IngredientModel', name: string, iconUrl: string, price: number } }> | null, recipeSteps?: Array<{ __typename?: 'RecipeStepModel', title: string, description: string, image: string }> | null, nutritionFact?: { __typename?: 'NutritionFact', carbohydrates: number, fats: number, proteins: number, fiber: number } | null } };
